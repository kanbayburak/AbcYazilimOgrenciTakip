...
namespace AbcYazilim.OgrenciTakip.Ul.Win.Functions
{
    public class TablePrintingFunctions
    {
        ...
        private static void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            _ps.Graph.DrawBrick(sayfaBrick, new RectangleF(0, 40, 50, 15));
        ...
        private static void RaporuKagidaSigdir()
        {
            ...
            {
                case RaporuKagidaSigdirma.SutunlariDaraltarakSigdir:
                    _tablo.OptionsPrint.AutoWidth = true;
                    break;
                case RaporuKagidaSigdirma.YaziBoyutunuKuculterekSigdir:
