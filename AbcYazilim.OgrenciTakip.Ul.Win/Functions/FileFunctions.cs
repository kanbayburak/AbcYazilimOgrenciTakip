...
namespace AbcYazilim.OgrenciTakip.Ul.Win.Functions
{
    ...
    //Xml dosyası oluşrutuyoruz
    //bu xml dosyasını hem baselistform hemde baseeditform da kullanılacak
    ...
    public static class FileFunctions
    {
        ...
        public static void TabloDisariAktar(this GridView tablo, DosyaTuru dosyaTuru, string dosyaFormati, string excelSayfaAdi =null)
        {
            ...
            var filePath = $@"{Application.StartupPath}\Temp{dosyaAdi}";    //filePath ve FileName belirledik
